...
import 'package:feedback_github/src/feedback/src/l18n/localization.dart';
import 'package:feedback_github/src/feedback/src/theme/feedback_theme.dart';
import 'package:feedback_github/src/feedback/src/utilities/media_query_from_window.dart';
...
class FeedbackApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (MediaQuery.maybeOf(context) == null) {
      mediaQueryWrapper = MediaQueryFromWindow(
        child: Builder(
          builder: (innerContext) {
            return FeedbackTheme(
              data: _buildThemeData(innerContext),
              child: child,
            );
          },
        ),
      ...
      mediaQueryWrapper = FeedbackTheme(
